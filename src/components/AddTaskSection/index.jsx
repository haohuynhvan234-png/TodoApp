...
export const AddTaskSection = ({ handleSubmit, inputValue, setInputValue }) => {
  ...
  return (
    <form className="relative mb-5">
      ...
      <button
        ...
        type="submit"
        className={`absolute right-2 top-2 bottom-2 aspect-square flex items-center justify-center ${newTask.trim() ? "bg-[#4f67ff]/50 text-white" : "bg-[#0093b4] text-[#475569]"} bg-[#4f67ff]/50 text-white rounded-[12px] transition-colors "}`}
